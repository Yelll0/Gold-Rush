...
HUD::HUD(Game* game, Controller* controller, Player* player) : UIScreen(game, controller), mPlayer(player)
{
	...
	mButtons.emplace(mButtons.end(), new Button(this, 2, Vector2(219.f, -234.f), Vector2(0.f, 0.f), NULL));
	mButtons.emplace(mButtons.end(), new Button(this, 7, Vector2(184.f, -234.f), Vector2(0.f, 0.f), NULL));
